...
const ChangeUsernameComponent = () => {
    const {handleChange, handleReset, values, errors} = useChangeUsernameForm(userNameFormValidate);
              ...
              <div className={styles.formInputComponent}>
                <Row>
                  ...
                  <Col>
                    ...
                    />
                    {errors.newFirstname && (errors.newFirstname).map((error)=> <p>{error}</p>)}
                  </Col>
                  <Col></Col>
                </Row>
              </div>
                  ...
                  <Col>
                    <input
                      ...
                      placeholder="Enter your lastname"
                        ...
                        onChange={handleChange}
                    />
                    {errors.newLastname && (errors.newLastname).map((error)=> <p>{error}</p>)}
                  </Col>
                  <Col></Col>
                </Row>
              </div>
