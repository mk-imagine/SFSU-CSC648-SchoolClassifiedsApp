...
("Dictionary", "It's a dictionary", 15.00, 'dictionary.jpeg', 3, 2),
("Gooseneck Kettle", "For your everyday coffee.", 25.00, 'gooseneckkettle.jpeg', 8, 4),
("Bicycle Helmet", "To protect your brain on dangerous SF roads.", 30.00, 'helmet.jpeg', 5, 3),
("Ice Sculpture", "For incredible parties! Pick it up soon before it melts", 999.00, 'icesculpture.jpeg', 1, 7),
("A white lamp", "So you can stay up late, studying.  It's boring so it won't distract you.", 50.00, 'amp.jpeg', 2, 6),
("Snowboard", "Jump on this popsicle stick and barrel down the mountain! WHEEE!", 200.00, 'snowboard.jpeg', 5, 5),
